    ...
    if (teks == '404') {
      ...
      const sections = [
      {
        ...
        rows: [
          ...
          { title: 'Data Base 📂', rowId: `${_p}? database` },
          { title: 'Vote & Absen 🗣️', rowId: `${_p}? vote` },
          { title: 'Al Quran 📖', rowId: `${_p}? quran` },
          { title: 'Pengubah Suara 🔊', rowId: `${_p}? audio` },
          { title: 'Jadi Bot(Maintenance)', rowId: `${_p}? jadibot` },
          { title: 'Info 🏢', rowId: `${_p}? info` },
          { title: 'Other Menu 🛴', rowId: `${_p}? tanpakategori` },
          { title: 'Owner 🙍‍♂️', rowId: `${_p}? owner` },
        ]
      }
    ]
    const listMessage = {
